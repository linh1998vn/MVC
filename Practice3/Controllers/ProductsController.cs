...
namespace Practice3.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.CategoryId = new SelectList(db.classes, "CategoryId", "CategoryName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ProductId,Name,Price,Quantity,ReleaseDate,CategoryId")] Product product)
        {
            ...
            ViewBag.CategoryId = new SelectList(db.classes, "CategoryId", "CategoryName", product.CategoryId);
            return View(product);
        }
